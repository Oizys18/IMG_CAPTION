...
preprocess.dataset_split_save(BASE_DIR, config.caption_file_path, config.test_size)

# tokenizer 호출
tokenizer = preprocess.get_tokenizer(tokenizer_path, config.caption_file_path, config.num_words)
