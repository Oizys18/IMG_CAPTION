...
# feature 생성
img_name_vector_aug = feature_extraction()
...
cap_vector, max_length = preprocess.change_text_to_token(
    train_captions, tokenizer_path)
# img_name_train, img_name_val, cap_train, cap_val = train_test_split(img_name_vector_aug,
#                                                                     cap_vector,
