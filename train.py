...
#
# # 전체 데이터셋을 분리해 저장하기
# train_dataset_path, val_dataset_path = preprocess.dataset_split_save(dataset, config.test_size, config.random_state)
#
# # tokenizer 만들기
# preprocess.save_tokenizer(dataset)


# 저장된 데이터셋 불러오기
train_dataset_path = './datasets/train_datasets.npy'
val_dataset_path = './datasets/val_datasets.npy'
dataset_path = train_dataset_path if config.do_what == 'train' else val_dataset_path
